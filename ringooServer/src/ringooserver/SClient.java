                ...
                try {
                    ...
                    switch (received.type) {
                        ...
                        case Disconnect:
                            break;
                        case Text:
                            //gelen mesaj metnini direkt rakibe gönder
                        ...
                        case Selected:
                            ...
                            break;
                        case zilNumber:
                            // gelen zile basıldı bilgisibi rakibe gönder
                             Server.Send(TheClient.rival, received);
                            break;
                        case mypoint:
                            // puan kazandıysam bunu  rakibe gönder
                            Server.Send(TheClient.rival, received);
                            break;
                        case point:
                            // ortada biriken kart sayısı point olarak belirtildi,
                            // bir oyuncu ortadaki kartları alınca point bilgisi 0 yapılır.
                            // bu sıfır bilgisini göndermek için kullanılır.
                            Server.Send(TheClient.rival, received);
                            break;
                        case Rpoint:
                            // yanlış hamle yapıp rakibe puan kazandırırsak bunu karşı tarafa bildir.
                            Server.Send(TheClient.rival, received);
                            break;
                        case Bitis:
                            break;
